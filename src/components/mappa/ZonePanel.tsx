...
export default function ZonePanel({
  ...
  return (
    <div className="fixed inset-x-0 bottom-28 md:absolute md:inset-x-auto md:right-3 md:top-20 md:bottom-auto md:w-80 z-[1000] bg-white border border-slate-200 md:rounded-xl overflow-hidden flex flex-col max-h-[min(72vh,calc(100vh-9rem))] md:max-h-[calc(100%-5.75rem)] shadow-lg">
