    ...
    ...(search
      ? {
          OR: [
            ...
            { telefono2: { contains: search, mode: "insensitive" as const } },
            { indirizzo: { contains: search, mode: "insensitive" as const } },
            { cap: { contains: search, mode: "insensitive" as const } },
            { citta: { contains: search, mode: "insensitive" as const } },
            { provincia: { contains: search, mode: "insensitive" as const } },
            { marcaStufa: { contains: search, mode: "insensitive" as const } },
            { modelloStufa: { contains: search, mode: "insensitive" as const } },
