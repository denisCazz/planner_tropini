...
VALUES
  ('org_Bitora', 'Bitora', 'Bitora', false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
UPDATE "Client" SET "organizationId" = 'org_Bitora';
...
INSERT INTO "Settings_new" ("id", "organizationId", "startLat", "startLng", "startLabel", "nearestNeighbours")
SELECT 'set_Bitora', 'org_Bitora', 44.7089, 7.6617, 'Via San Giorgio 14, Cavallermaggiore', 4
...
UPDATE "RouteHistory" SET "organizationId" = 'org_Bitora';
...
-- Demo sample clients (isolated from Bitora data)
INSERT INTO "Client" (
